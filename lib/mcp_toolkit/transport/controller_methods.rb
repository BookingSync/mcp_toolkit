...
module McpToolkit
  module Transport
    # The MCP Streamable-HTTP transport, extracted from bsa-notifications'
    # `McpServer::ServerController` as an includable concern. An app's controller
    # includes this to get the full transport with no per-app code:
    #
