...
require_relative "tools/resource_schema"
...
module McpToolkit
  ...
  #
  # Extracted from bsa-notifications' `McpServer::Server`, with the official `mcp`
  # gem as the JSON-RPC core (per the 2026-06-18 architecture decision: standardize
  # on the gem, wrapped, rather than a hand-rolled protocol).
  module Server
